...
class Bot:
    ...
    def download_user_photo(self, msg):
        ...
        if not self.is_current_msg_photo(msg):
            ...
            text = "Please upload a photo server ec2."
        ...
        logger.info(f'the folder name is = {folder_name}')
...
class ObjectDetectionBot(Bot):
       def handle_message(self, msg):
        ...
        if img_path:
            ...
            logger.info(f'the path is : {img_path}')
            ...
            text = f' Your image {temp[0]} is being processed. Please w in ec2 wait...'
            self.send_text(msg['chat']['id'], text)
        else:
