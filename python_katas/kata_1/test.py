...
class TestVerbing(unittest.TestCase):
    ...
    def test_two_char(self):
        test_word = 'mu'
        self.assertEqual(questions.versing(test_word), "mu")

    def test_gaming(self):
        test_word = 'gaming'
        self.assertEqual(questions.versing(test_word), "gamingly")

    def test_ing(self):
        test_word = 'ing'
        self.assertEqual(questions.versing(test_word), "ingly")

    def test_in(self):
        test_word = 'cartin'
        self.assertEqual(questions.versing(test_word), "cartining")
